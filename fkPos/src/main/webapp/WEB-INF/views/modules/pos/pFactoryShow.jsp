...
<body>
	...
	<form:form id="inputForm" modelAttribute="pFactory" action="${pageContext.request.contextPath}/pos/pFactory/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="factoryName" htmlEscape="false" maxlength="200" class="input-xlarge required"  disabled="true"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="factoryStatus" class="input-xlarge required"  disabled="true">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="manager" htmlEscape="false" maxlength="50" class="input-xlarge "  disabled="true"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">经理手机：</label>
			<div class="controls">
				<form:input path="managerMobile" htmlEscape="false" maxlength="15" class="input-xlarge "  disabled="true"/>
			</div>
		</div>
		<div class="control-group">
