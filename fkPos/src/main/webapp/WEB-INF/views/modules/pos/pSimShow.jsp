...
<body>
	...
	<form:form id="inputForm" modelAttribute="pSim" action="${pageContext.request.contextPath}/pos/pSim/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:textarea path="repairRemarks" htmlEscape="false" rows="4" maxlength="255" class="input-xxlarge " disabled="true"/>
			</div>
		</div>			
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:textarea path="scrappedRemarks" htmlEscape="false" rows="4" maxlength="255" class="input-xxlarge " disabled="true"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">押金(元)：</label>
			<div class="controls">
				<form:input path="simDeposit" htmlEscape="false" maxlength="16" class="input-xlarge " disabled="true"/>
			</div>
		</div>		
		<div class="control-group">
