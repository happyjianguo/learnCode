...
<head>
	...
	<script type="text/javascript">
		...
		var checkTermPos = function() {
			var terminalId=$.trim($("#terminalId").val());
			if(terminalId!=""){
				$.ajax({
					url : '${pageContext.request.contextPath}/pos/pPos/checkTermPos',
					type : "post",
					data : {
...
<body>
	<div class="sh_title">POS机出库</div>	
	<form:form id="inputForm" modelAttribute="pPos" action="${pageContext.request.contextPath}/pos/pPos/outStock" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="terminalId" htmlEscape="false" maxlength="8" class="input-xlarge required" onblur="checkTermPos();"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>		
