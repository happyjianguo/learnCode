...
<body>
	<div class="sh_title">POS机报废</div>	
	<form:form id="inputForm" modelAttribute="pPos" action="${pageContext.request.contextPath}/pos/pPos/scrap" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:textarea path="scrappedRemarks" htmlEscape="false" rows="4" maxlength="80" class="input-xxlarge "/>
			</div>
		</div>
