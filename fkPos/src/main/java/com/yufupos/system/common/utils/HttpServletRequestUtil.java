...
public class HttpServletRequestUtil {
	...
	/*
	 * public static Date getRepuestParameterToDate(HttpServletRequest request,
	 * String key , Date defaultValue , String pattern) throws ParseException{
	 * String value = request.getParameter(key); if(value == null){ return
	 * defaultValue; }
	 * 
	...
	// public static Map<String, String> getRepuestParameterToMap(
