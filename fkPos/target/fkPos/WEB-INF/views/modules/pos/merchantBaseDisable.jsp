...
<body>
	<div class="sh_title">商户停用界面</div>	
	<form:form id="inputForm" modelAttribute="merchantBase" action="${pageContext.request.contextPath}/pos/merchantBase/disableSave" method="post" class="form-horizontal">
		<form:hidden path="id"/>
