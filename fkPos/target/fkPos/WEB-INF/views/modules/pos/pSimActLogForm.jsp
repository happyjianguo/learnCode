						...
						success : function(data) {						
							if (data.result == '0') {								
								layer.alert(data.resultMsg, 1, function() {								
									$("#searchForm", window.parent.document).attr("action","/pos/pSimActLog/list");
...
<body>
	<div class="sh_title">SIM卡操作记录</div>	
	<form:form id="inputForm" modelAttribute="pSimActLog" action="${pageContext.request.contextPath}/pos/pSimActLog/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>		
		<div class="control-group">
			<label class="control-label">SIM卡ID：</label>
			<div class="controls">
				<form:input path="simId" htmlEscape="false" maxlength="64" class="input-xlarge required" disabled="true"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="simActType" class="input-xlarge " disabled="true">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="simActMsg" htmlEscape="false" maxlength="500" class="input-xlarge " disabled="true"/>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<input name="createDate" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
					value="<fmt:formatDate value="${pSimActLog.createDate}" pattern="yyyy-MM-dd HH:mm:ss"/>"
