...
import cn.com.jansh.entity.data.IMUserAna;
...
public interface UserAnalysisMapper {
	...
	public BigDecimal QuerryUserAnalysisTotal(@Param("starttime")String starttime,@Param("endtime")String endtime,@Param("appid")String appid);
