...
public class StringUtil {
     ...
     * @return
     */
    public static String getSystemTradeNo() {
    	return new SimpleDateFormat("yyyyMMddHHmmss").format(new Date()) + StringUtil.getRandomNumberByLength(6);
    }
    
	/**
     * 根据长度获取当天指定的数字字母组合字符串
     * @param length 指定字符串长度
     * @return 一定长度的字符串
     */
    public static String getRandomByLengthOfDate(int length) {
