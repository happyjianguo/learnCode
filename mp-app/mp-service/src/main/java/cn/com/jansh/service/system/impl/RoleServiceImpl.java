...
public class RoleServiceImpl implements RoleService {
	...
	public void addRole(RoleManageModel roleManageModel) throws AppException {
		logger.info("新增角色",roleManageModel);
...
//			imRole.setCreateTime(DateUtil.formatDateTimestamp(imRole.getCreateTime()));
//			imRole.setUpdateTime(DateUtil.formatDateTimestamp(imRole.getUpdateTime()));
		}
		return list;
	}
	 ...
	 */
	@Override
	public void deleteRoleByIds(String[] roleIds) throws AppException {
		logger.info("批量删除角色");
