/**
 * CloudaccountsurplusrevModel.java
 ...
 * @version 1.0
 */
public class CloudaccountsurplusrevModel {
    ...
    /** 充值审核数据列表 */
    private List<CloudaccountsurplusrevEntity> accountsurpList;
	...
	/**
	 * @return the accountsurpList
	 */
	public List<CloudaccountsurplusrevEntity> getAccountsurpList() {
		return accountsurpList;
	}

	/**
	 * @param accountsurpList the accountsurpList to set
	 */
	public void setAccountsurpList(List<CloudaccountsurplusrevEntity> accountsurpList) {
		this.accountsurpList = accountsurpList;
	}
