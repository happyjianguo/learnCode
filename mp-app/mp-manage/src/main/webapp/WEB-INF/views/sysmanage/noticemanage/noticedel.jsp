...
<body>
	<div class="main-content">
		<div class="list-nav">
			<ol class="breadcrumb">
				<li>公告管理</li>
				<li class="active" id="bill_check">删除公告</li>
			</ol>
		</div>
		<div class="mainbox">
			<div class="row">
				<form:form id="noticeeditform" modelAttribute="noticeManageModel" action="${ctxPath}/notice/deldata" methodParam="post"
