...
<body>
	<div class="main-content">
		<div class="list-nav">
			<ol class="breadcrumb">
				<li>机构管理</li>
				<li class="active" id="bill_check">删除机构</li>
			</ol>
		</div>
		<div class="mainbox">
			<div class="row">
				<form:form id="orginationdelform" modelAttribute="cloudplatformorginationModel" action="${ctxPath}/orgination/deldata" methodParam="post"
					...
					<div class="form-group">
						<label class="col-sm-4 control-label">机构状态</label>
							<div class="col-sm-4">
							      <select id="orgstatus" name="orgstatus" class="form-control select" disabled="disabled">
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<form:textarea path="note" cssClass="form-control" cols="20" rows="10" readonly="true"/>
						</div>
					</div>
					<div class="form-group">
