...
<body>
	<div class="main-content">
		<div class="list-nav">
			<ol class="breadcrumb">
				<li>游戏模板分类管理</li>
				<li class="active" id="bill_check">删除游戏模板分类</li>
			</ol>
		</div>
		<div class="mainbox">
			<div class="row">
				<form:form id="addform" modelAttribute="cloudGameTemplateTypeModel" action="${ctxPath}/gametmptype/deldata" methodParam="post"
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<form:input path="tmptypename" cssClass="form-control" readonly="true"/>
						</div>
					</div>
					<div class="form-group">
