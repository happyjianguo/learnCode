...
<body>
	<div class="main-content">
		...
		<div class="mainbox">
			<div class="row">
				<form:form id="usereditform" modelAttribute="registerReviewModel" action="${ctxPath}/membermanage/deldata" methodParam="post"
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
								<select id="mf" name="mf" class="form-control select" disabled="disabled">
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<select id="orgid" name="orgid" class="form-control select" disabled="disabled">
