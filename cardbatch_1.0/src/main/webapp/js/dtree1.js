...
//==================================================
// Node object
function Node(id, pid, cname, cvalue, cshow, cchecked, cdisabled, surl, title, target, icon, iconOpen, open,level) {
	this.id = id;
	this.pid = pid;
	//chechboxµÄÃû³Æ
	this.cname = cname;
...
dTree.prototype.add = function(id, pid, cname, cvalue, cshow, cchecked, cdisabled, url, title, target, icon, iconOpen, open,level) {
	this.aNodes[this.aNodes.length] = new Node(id, pid, cname, cvalue, cshow, cchecked, cdisabled, url, title, target, icon, iconOpen, open,level);
};
