...
<body>
	<html:form styleId="bankForm"
		action="/bank?method=getTBranchInfoList" method="post">
				...
				<td align="center" valign="top">
					...
					<table border="0" cellpadding="0" cellspacing="0" width="100%">
						...
						<tr>
							...
							<td align="left" class="box2">
								<html:text property="branch_code" maxlength="16" disabled="true"></html:text>
							</td>
						</tr>
						<tr>
							<td style="width: 110px;" align="right" class="box1">
							...
							<td align="left" class="box2">
								<html:text property="branch_name" maxlength="30" disabled="true"></html:text>
							</td>
						</tr>
					</table>
					<table border="0" cellpadding="0" cellspacing="0" width="100%">
