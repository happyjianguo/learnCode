...
<body>
	<html:form styleId="bankForm"
		action="/bank?method=getTBankInfoList" method="post">
					...
					<table border="0" cellpadding="0" cellspacing="0" width="100%">
						...
						<tr>
							...
							<td align="left" class="box2">
								<html:text property="bank_code" maxlength="16" disabled="true"></html:text>
							</td>
						</tr>
						<tr>
							<td style="width: 110px;" align="right" class="box1">
							...
							<td align="left" class="box2">
								<html:text property="bank_name" maxlength="10" disabled="true"></html:text>
							</td>
						</tr>
						<tr>
							<td style="width: 110px;" align="right" class="box1">
							...
							<td align="left" class="box2">
								<html:text property="bank_short_name" maxlength="8" disabled="true"></html:text>
							</td>
						</tr>
						<tr>
							<td style="width: 110px;" align="right" class="box1">
							...
							<td align="left" class="box2">
								<html:text property="logo" maxlength="50" disabled="true"></html:text>
							</td>
						</tr>
					</table>
					<table border="0" cellpadding="0" cellspacing="0" width="100%">
