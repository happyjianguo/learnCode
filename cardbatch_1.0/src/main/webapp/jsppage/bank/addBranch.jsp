...
<script type="text/javascript">	
   	function commit() {
		if (!checkelement("bankForm", "branch_code", "银行支行编号")) {
			return false;
		}   
	...
	function getTBranchInfoList(){
		var bankForm = document.all("bankForm");
		bankForm.action = "<%=path%>/bank.do?method=getTBranchInfoList";
		bankForm.submit();
	}
...
<body>
	<html:form styleId="bankForm"
		action="/bank?method=addTBranchInfoInfo" method="post">
				...
				<td align="center" valign="top">
					...
					<table border="0" cellpadding="0" cellspacing="0" width="100%">
						...
						<tr>
							...
							<td align="left" class="box2">
								<html:text property="branch_code" maxlength="16" onblur="checkTBranchInfoPK();"></html:text>
							</td>
						</tr>
						<tr>
							<td style="width: 110px;" align="right" class="box1">
