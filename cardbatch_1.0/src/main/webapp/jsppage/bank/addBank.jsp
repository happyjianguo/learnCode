...
<script type="text/javascript">	
   	function commit() {
		if (!checkelement("bankForm", "bank_code", "银行编号")) {
			return false;
		}   
		if (!checkelement("bankForm", "bank_name", "银行名称")) {
			return false;
		}  		    	    
...
<body>
	<html:form styleId="bankForm" action="/bank?method=addTBankInfo" method="post">
					...
					<table border="0" cellpadding="0" cellspacing="0" width="100%">
						...
						<tr>
							...
							<td align="left" class="box2">
								<html:text property="bank_code" maxlength="16" onblur="checkTBankInfoPK();"></html:text>
							</td>
						</tr>
						<tr>
							<td style="width: 110px;" align="right" class="box1">
							...
							<td align="left" class="box2">
								<html:text property="bank_name" maxlength="15"></html:text>
							</td>
						</tr>
						<tr>
							<td style="width: 110px;" align="right" class="box1">
							...
							<td align="left" class="box2">
								<html:text property="bank_short_name" maxlength="15"></html:text>
							</td>
						</tr>
						<tr>
							<td style="width: 110px;" align="right" class="box1">
							...
							<td align="left" class="box2">
								<html:text property="logo" maxlength="50"></html:text>
							</td>
						</tr>
					</table>
					<table border="0" cellpadding="0" cellspacing="0" width="100%">
