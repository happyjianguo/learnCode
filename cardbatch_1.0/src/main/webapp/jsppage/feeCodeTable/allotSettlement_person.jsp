...
<script type="text/javascript">
	...
	function commit() {
		var merchant_org =  document.getElementsByName("settlement_person")[0].value;
...
<body>
	<html:form styleId="merchantForm"
		action="/merchant?method=allotSettlement_person"
					...
					<table border="0" cellpadding="0" cellspacing="0" width="100%">
						<tr>
							...
							<td align="left" class="box2">
								<html:text property="settlement_person" maxlength="20"></html:text><font color="red">*</font>
							</td>
						</tr>
					</table>
					<table border="0" cellpadding="0" cellspacing="0" width="100%">
