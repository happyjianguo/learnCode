...
<script type="text/javascript">
	...
	function commit() {
		var merchant_org =  document.getElementsByName("merchant_fenrunorg")[0].value;
...
<body>
	<html:form styleId="merchantForm"
		action="/merchant?method=allotMerchant_fenrunorg"
