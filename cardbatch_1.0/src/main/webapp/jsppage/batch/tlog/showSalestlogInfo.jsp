						...
						<table border="0" cellpadding="0" cellspacing="0" width="80%"  class = "box1">
							...
							<tr>
								...
								<td align="left" class="box2">									
									<bean:write name="salestlogBean" property="currbill"/>
								</td>
							...
							<tr>
								...
								<td align="left" class="box2">									
									<bean:write name="salestlogBean" property="rateset"/>
								</td>
								<td align="left" class="box2" width="40%">
							...
							<tr>
								...
								<td align="left" class="box2">									
									<bean:write name="salestlogBean" property="amttxn_jy"/>
								</td>
								<td align="left" class="box2" width="40%">
							...
							<tr>
								...
								<td align="left" class="box2">									
									<bean:write name="salestlogBean" property="curtxn"/>
								</td>
								<td align="left" class="box2" width="40%">
							...
							<tr>
								...
								<td align="left" class="box2">									
									<bean:write name="salestlogBean" property="crdproduct"/>
								</td>
								<td align="left" class="box2" width="40%">
