...
<script language="javascript">
 ...
 function	addPanInfoAgain(){
	 window.location.href="<%=path%>/bflowlog.do?method=addPanInfoAgain&panflagno=<%=panflagno%>";
 }	
</script>
<center>
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%" height="99%" >
				<tr>
					...
					<tr>
						...
						<td   height="28" style=" background:url(<%=path%>/image1/Navigation_bar/middle.gif) repeat-x;"  > &nbsp;&nbsp;当前位置：批量管理 &gt; 批量发卡管理&gt; 发卡日志详细信息 </td>
