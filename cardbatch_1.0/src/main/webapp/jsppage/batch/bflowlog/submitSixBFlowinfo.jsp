...
<html>
  <head>    
	...
	function submitstatsT(panflagno,batchflag){	
		//从单独到综合
		ShellServiceOfHousekeep.readstatsSix(panflagno,batchflag);				
	}
  ...
  <body>	
							...
							<table width="100%" border="0" align="center" cellpadding="0"
								...
								<tr>
									...
									<td width="80%" height="40" align="center">
										<font color="green" id="msginfo">脚本正在执行，请耐心等待!<br/>受理号：<bean:write name="sixbFlowLogBean" property="panflagno" /></font>
									</td>
	...
	<script>
	submitstatsT('<bean:write name="sixbFlowLogBean" property="panflagno" />','<bean:write name="sixbFlowLogBean" property="batchflag"/>');
	</script>
  </body>
</html>
