...
<script language="javascript">
	...
	function query(){
		...
		bflowlogForm.action = "<%=path%>/bflowlog.do?method=queryBFlowLogList";
		bflowlogForm.submit();
	}
...
<shiro:lacksPermission name="housekeep:kaikaList:view">
    <div class="permission_error">用户[${fns:getUserName()}]没有该权限<br/></div>
</shiro:lacksPermission>
<shiro:hasPermission name="housekeep:kaikaList:view">
<body bottommargin="0" leftmargin="0" topmargin="0" rightmargin="0" >
<html:form action="/bflowlog.do?method=getBFlowLogList" method="post" styleId="bflowlogForm">
		...
		<tr>
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
					...
					<tr>
						...
						<td   height="28" style=" background:url(<%=path%>/image1/Navigation_bar/middle.gif) repeat-x;"  > &nbsp;&nbsp;当前位置：批量管理 &gt; 批量处理管理 </td>
			...
			<table  cellpadding="0" cellspacing="0" width="100%" class="serch" style="padding:5px;"  align="left"  >
				...
				<table  cellpadding="0" cellspacing="0" width="100%" border="0" >
					<tr  id="tl" height="35" align="center" style="top: expression(this.offsetParent.scrollTop);position: relative;border-style: none" >
						...
						<shiro:hasPermission name="housekeep:kaikaList:edit">
						<td>
							手动修改
						</td>
						</shiro:hasPermission>
						...
						<tbody  class="list" >
					<logic:present name="bflowlogList">
							<logic:iterate id="bflowlogBean" name="bflowlogList">
								<tr align="center" onMouseOver="changeClass(this,1)" onMouseOut="changeClass(this,2)">
									...
									<td class=box2 height="28">
										<bean:write name="bflowlogBean" property="batchname"/>&nbsp;
									</td>								 
									<td class=box2 height="28">
									...
									<td class=box2 height="28">
										<bean:write name="bflowlogBean" property="execdateday"/>&nbsp;
									</td>
									<td class=box2 height="28">
										<bean:write name="bflowlogBean" property="execdatemin"/>&nbsp;
									</td>
									<td class=box2 height="28">
										<logic:equal name="bflowlogBean" property="execflag"	value="0">自动执行&nbsp;</logic:equal>
										<logic:notEqual name="bflowlogBean" property="execflag"	value="0">手动执行&nbsp;</logic:notEqual>
									</td>
						          <td class=box2 height="28">
							             <html:link action="/bflowlog.do?method=showBFlowLogInfo"
												paramId="id" paramName="bflowlogBean"
												paramProperty="id">
						          ...
						          <shiro:hasPermission name="housekeep:kaikaList:edit">
							          <td class=box2 height="28">
							          <logic:notEqual name="bflowlogBean" property="issucess"	value="0">							          
										 <span style="cursor:hand" onclick="callshellupdate('<bean:write name="bflowlogBean" property="id"/>')">手动修改</span>
									   </logic:notEqual>
									   &nbsp;
							          </td>
						          </shiro:hasPermission>					          		
					...
					<logic:notPresent name="bflowlogList">
						<%int i=6; %>
						<%i++; %>
