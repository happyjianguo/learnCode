...
<script language="javascript">
	...
	function commit(){
		...
		var flagnumss = document.getElementById("flagnum").value; 
...
<center>
	<body bottommargin="0" leftmargin="0" topmargin="0" rightmargin="0">
		<html:form styleId="bflowlogForm" action="/bflowlog.do?method=addPanInfo" method="post" >
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%" height="99%" >
				<tr>
					...
					<tr>
						...
						<td   height="28" style=" background:url(<%=path%>/image1/Navigation_bar/middle.gif) repeat-x;"  > &nbsp;&nbsp;当前位置：批量管理 &gt; 批量发卡管理&gt; 发卡 </td>
						...
						<table border="0" cellpadding="0" cellspacing="0" width="700"  class = "box1">							
							<tr>
								...
								<td align="left" class="box2">
									<select id="batchflag" name="batchflag" onchange="checkkabin()">
							...
							<tr>
								...
								<td align="left" class="box2">
									<select id="flagnum" name="flagnum">
									<option value="">－请选择－</option>
									<option value="1">卡号不允许带4</option>
									<option value="0">卡号允许带4</option>
								</select>
								</td>
								<td align="left" class="box2" width="40%">
							...
							<tr id="trvalid">
								...
								<td align="left" class="box2">
									<html:text property="yeardate" maxlength="10"  onclick="fPopCalendar(yeardate,yeardate);return false" readonly="true"  ></html:text>
								</td>
								<td align="left" class="box2" width="40%">
									<font color="red"></font>
								</td>	
