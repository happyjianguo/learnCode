...
<script language="javascript">
 ...
 function	addPanInfoAgain(){
	 window.location.href="<%=path%>/mcVirtualCard.do?method=addPanInfoAgain&panflagno=<%=panflagno%>";
 }
</script>
<center>
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%" height="99%" >
				<tr>
					...
					<tr>
						...
						<td   height="28" style=" background:url(<%=path%>/image1/Navigation_bar/middle.gif) repeat-x;"  > &nbsp;&nbsp;当前位置：批量管理 &gt; 生成同福卡绑定的虚拟卡管理&gt; 发卡日志详细信息 </td>
					 ...
					 <tr>
						...
						<table border="0" cellpadding="0" cellspacing="0" width="80%"  class = "box1">
							...
							<tr>
								...
								<td width="50%" align="left" class="box2">									
									<bean:write name="bflowlogBean" property="panflagno"/>
								</td>
								<td></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td align="left" class="box2">
									...
									<logic:notEqual name="bflowlogBean" property="issucess"	value="0">失败&nbsp;<%=errMsg%></logic:notEqual>
