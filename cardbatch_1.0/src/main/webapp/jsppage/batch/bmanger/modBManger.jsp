...
<center>
	<body bottommargin="0" leftmargin="0" topmargin="0" rightmargin="0">
		<html:form styleId="bmangerForm" action="/bmanger.do?method=modBManger" method="post" >
			<table border="0" cellpadding="0" cellspacing="0" width="100%" height="99%" >
				<tr>
					...
					<tr>
						...
						<td   height="28" style=" background:url(<%=path%>/image1/Navigation_bar/middle.gif) repeat-x;"  > &nbsp;&nbsp;当前位置：批处理管理 &gt; 批处理维护&gt; 修改批处理 </td>
						...
						<table border="0" cellpadding="0" cellspacing="0" width="80%"  class = "box1">
							<tr>
								...
								<td width="50%" align="left" class="box3">
									...
									<bean:write name="bmangerForm" property="id"/>
								</td>
								<td width="30%"></td>
							</tr>
							<tr>
								<td  width="20%" align="right" class="box1">
									<font color="red">批处理标识：</font>
								</td>
								<td width="50%" align="left" class="box2">
									<html:text property="batchflag" maxlength="30"></html:text>
								</td>
								<td width="30%"></td>
							</tr>
							<tr>
