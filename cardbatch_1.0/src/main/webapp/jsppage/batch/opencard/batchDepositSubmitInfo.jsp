  ...
  <head>    
    ...
    function loadPage(){
     ...
     if (flushdo == path + "closewindow"){
    	 window.location.href="<%=path%>/deposit.do?method=getDepositList&batch_stat_query="+batch_stat_query+"&pay_type_query="+pay_type_query+"&sales_point_query="+sales_point_query;
	  }
    }
</script>
