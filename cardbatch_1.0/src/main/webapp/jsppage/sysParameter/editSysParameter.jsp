...
<body>
	<html:form styleId="sysParameterForm" action="/sysParameter?method=modSysParameter" method="post">
		<input type="hidden" name="param_id"  value="${sysParameterForm.param_id}">	
					...
					<table border="0" cellpadding="0" cellspacing="0" width="100%">
						...
						<tr>
							...
							<td align="left" class="box2">
								<html:text property="param_type" maxlength="20" readonly="true"></html:text>
							</td>
						</tr>
						<tr>
							<td style="width: 110px;" align="right" class="box1">
							...
							<td align="left" class="box2">
								<html:text property="param_name" maxlength="30" readonly="true"></html:text>
							</td>
						</tr>
						<tr>
							<td style="width: 110px;" align="right" class="box1">
