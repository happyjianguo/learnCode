					...
					<tr>
						<td colspan="10">
							...
							<display:table name="cardList" partialList="true" size="pageBean.totalRecords" pagesize="10" style="width:100%" class="dpTable" cellpadding="0" cellspacing="0" id="displayTable" requestURI="/queryCard.do">
								<display:column title="姓名" style="text-align:center" property="cust_name" headerClass="sortable" sortable="true" />
								<display:column title="手机号" style="text-align:center" property="cell_phone" headerClass="sortable" sortable="true" />
								...
								<display:column title="客户详情" style="text-align:center" sortable="true">
