...
<script language="javascript">
	function conmmit(){
		var teamno = document.groupForm.teamno.value;
		var teamname = document.groupForm.teamname.value;
		if(trim(teamno) == ""){
			alert("请输入管理员组编号！");
			document.groupForm.teamno.focus();
			return false;
		}
		if(trim(teamname) == ""){
			alert("请输入管理员组名称！");
...
<center>
	<body bottommargin="0" leftmargin="0" topmargin="0" rightmargin="0">
		<html:form styleId="groupForm" action="/userGroup?method=addGroup" method="post" focus="teamno">
						...
						<table border="0" cellpadding="0" cellspacing="0" width="80%">
							...
							<tr>
								<td height="30" align="center">
									<font color="blue" class="big">增 加 管 理 员 组</font>
								</td>
							</tr>
						</table>
						<table border="0" cellpadding="0" cellspacing="0" width="80%">
							<tr>
								...
								<td align="left" class="box3">
									<html:text property="teamno" maxlength="3"></html:text>
								</td>
							</tr>
							<tr>
								<td width="100" align="right" class="box1">
