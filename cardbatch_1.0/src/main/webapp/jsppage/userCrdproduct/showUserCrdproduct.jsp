...
<script type="text/javascript">	
    function loadMy(){
    	var crdProductStr='${userCrdproductForm.crdproduct}';
    	var shuzu=crdProductStr.split(",");
        $(":checkbox").each(
          function(){
...
<body onload="loadMy()">
	<html:form styleId="userCrdproductForm" action="/userCrdproduct?method=getUserCrdproductList" method="post">
					...
					<table border="0" cellpadding="0" cellspacing="0" width="100%">
						...
						<tr>
							...
							<td align="left" class="box2">
								<html:hidden property="user_code"/>							
								<html:select property="user_code" disabled="true">
							...
							<td align="left" class="box2">
								...
								<c:forEach var="list" items="${cardProductList}"
									...
									<input type="checkbox" name="crdproductCB"
										value="${list.crdproduct}" disabled="true"/>
