...
<body bottommargin="0" leftmargin="0" topmargin="0" rightmargin="0" bgproperties="fixed">
	<div style="position:absolute; overflow:auto; overflow-x:hidden; width:90%; height:500px; border:1px none #000000; left: 120px; top: 50px">
	<table id="tab" width="862" height="474" border="1" align="center" valign="middle" cellpadding="0" cellspacing="0" background="<%=path%>/images/background/welcome2.gif">
		<tr>
			<td>
				<table width="350" border="0" cellspacing="0" cellpadding="0"
					...
					<tr>
						<td align="right" background="<%=path%>/images/result/messges_left_01.gif" width="24"
								height="107">
						</td>
						...
						<td align="left" background="<%=path%>/images/result/messges_right_01.gif"
								width="23" height="107">
						</td>
					</tr>
					<tr>
						<td colspan="3" background="<%=path%>/images/result/messges_bottome_01.gif"
								width="350" height="18"">
						</td>
					</tr>
				</table>
