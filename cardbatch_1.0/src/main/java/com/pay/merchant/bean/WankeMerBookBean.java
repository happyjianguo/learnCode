...
public class WankeMerBookBean {
	...
	public WankeMerBookBean() {

	}

	public WankeMerBookBean(HashMap record) {
		//利用java反射机制为javabean赋值
		RecordMethod  recordMethod=new RecordMethod(record,WankeMerBookBean.class,this);
