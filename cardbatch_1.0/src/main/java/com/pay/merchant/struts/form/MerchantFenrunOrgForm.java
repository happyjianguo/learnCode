...
public class MerchantFenrunOrgForm extends ActionForm {
	private static final long serialVersionUID = 1L;
	
	private String orgId;  //分润机构ID
	...
	private String iidSelJSQ;//结算商户输入条件模糊查询
	private String iidJS_id;//结算商户，为了关联出结算账号
	
	
	public String getIidSelJSQ() {
		return iidSelJSQ;
	}
	public void setIidSelJSQ(String iidSelJSQ) {
		this.iidSelJSQ = iidSelJSQ;
	}
	public String getIidJS_id() {
		return iidJS_id;
	}
	public void setIidJS_id(String iidJS_id) {
		this.iidJS_id = iidJS_id;
	}
