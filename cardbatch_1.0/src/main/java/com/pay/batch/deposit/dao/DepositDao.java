package com.pay.batch.deposit.dao;
...
public class DepositDao {
    ...
    public String sqlparm(DepositForm querybean){
    	 ...
    	 if(querybean!=null){
    		 ...
    		 //充值类型
    		 if(null!=querybean.getCashin_type()&&!"".equals(querybean.getCashin_type())&&!"null".equals(querybean.getCashin_type())){
    			 sb.append(" and cashin_type ='").append(querybean.getCashin_type().trim()).append("' ");
    		 }
