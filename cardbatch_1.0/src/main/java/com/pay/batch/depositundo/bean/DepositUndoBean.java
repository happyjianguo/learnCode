/**
 *包名:com.pay.batch.depositundo.bean
 *描述:package com.pay.batch.depositundo.bean;
 */
package com.pay.batch.depositundo.bean;
...
/**
 * DepositUndoBean.java
 * 版权所有(C) 2017 裕福控股有限公司
 * 创建:gll 
 * 时间:2017年9月4日
 * 描述:TODO
 */
public class DepositUndoBean {
...
private String id;
	...
	public DepositUndoBean() {

	}

	public DepositUndoBean(HashMap record) {
		// 利用java反射机制为javabean赋值
		RecordMethod recordMethod = new RecordMethod(record, DepositUndoBean.class,
				this);
