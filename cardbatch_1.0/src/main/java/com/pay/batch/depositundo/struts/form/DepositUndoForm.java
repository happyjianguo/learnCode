/**
 *包名:com.pay.batch.depositundo.struts.form
 *描述:package com.pay.batch.depositundo.struts.form;
 */
package com.pay.batch.depositundo.struts.form;

import org.apache.struts.action.ActionForm;

/**
 * DepositUndoForm.java
 * 版权所有(C) 2017 裕福控股有限公司
 * 创建:gll 
 * 时间:2017年9月4日
 * 描述:批量充值撤销FORM
 */
public class DepositUndoForm extends ActionForm {
