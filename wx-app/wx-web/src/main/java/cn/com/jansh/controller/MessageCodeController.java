...
import cn.com.jansh.config.ConstDefine.CodeType;
import cn.com.jansh.util.CPublicUtils;
import cn.com.jansh.util.ImageUtil;
/**
 * 生成验证码（短信、图片）
 * @author duanmuyn
 */
...
public class MessageCodeController {
	...
	private final Logger logger = LogManager.getLogger(MessageCodeController.class);
	...
	public String getCode(HttpServletRequest request) throws JsonProcessingException{
		String msgcode = CPublicUtils.getRandomNumStr(6);
	...
	public void getImageCode(HttpServletRequest req,HttpServletResponse resp){
		...
		req.getSession().setAttribute(CodeType.IMAGECODE, imageCode);
