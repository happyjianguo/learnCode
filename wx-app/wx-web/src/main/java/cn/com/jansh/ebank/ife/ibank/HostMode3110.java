...
public class HostMode3110 {
	...
	protected void setTagId() {
		this.tagId = new String[] {"TradeCode", "CltSeqNo", "SRFlg", "AccTyp", "AccNo", "FindDate"};
	}
	/**
	 * 报文接口对应长度及类型。长度：不确定用"0"；类型：d-日期，n-数字，x-字符串。
	 */
	protected void setTagFormat() {
		this.tagFormat = new String[] {"4x", "14x", "1x", "4x", "32x", "8x"};
	}
	/**
	 * 交易请求数据
	 */
	protected void setTagName() {
		this.tagName = new String[] {"TRADECODE", "CLTSEQNO", "SRFLG", "ACCTYP", "ACCNO", "FINDDATE"};
	}
