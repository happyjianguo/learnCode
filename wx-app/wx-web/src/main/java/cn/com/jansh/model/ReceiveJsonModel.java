 ...
 * @version 1.0.0
 */
public class ReceiveJsonModel {
	
    private String errcode="";  //错误码
    private String errmsg="";  //错误信息
    private String subscribe="";  //用户是否订阅该公众号标识，值为0时，代表此用户没有关注该公众号，拉取不到其余信息，只有openid和UnionID（在该公众号绑定到了微信开放平台账号时才有）。
	...
	public String toString() {
		return "ReceiveJsonModel [errcode=" + errcode + ", errmsg=" + errmsg + ", subscribe=" + subscribe + ", openid="
				+ openid + ", nickname=" + nickname + ", sex=" + sex + ", city=" + city + ", country=" + country
				...
				+ groupid + ", msgid=" + msgid + ", template_id=" + template_id + "]";
	}
}
