...
public class AccessclientModel {
		...
		/**接入者列表-给查询条件使用 */
		private List<CfAccessclientEntity> accessclientListselect;
		/** 回掉地址*/
		...
		public List<CfAccessclientEntity> getAccessclientListselect() {
			return accessclientListselect;
		}

		public void setAccessclientListselect(List<CfAccessclientEntity> accessclientListselect) {
			this.accessclientListselect = accessclientListselect;
		}
		...
		public String toString() {
			return "AccessclientModel [id=" + id + ", acname=" + acname + ", cid=" + cid + ", cname=" + cname
					...
					+ cumulative + ", qid=" + qid + ", qcid=" + qcid + ", qstatus=" + qstatus + ", customerListselect="
					+ customerListselect + ", accessclientListselect=" + accessclientListselect + ", callbackurl="
					+ callbackurl + ", cfCustomerList=" + cfCustomerList + ", accessclientList=" + accessclientList
					+ "]";
		}
}
