...
import cn.com.jansh.core.menu.MenuUtils;
...
public class UserDetailServiceImpl implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		...
		userdetail.setMenuList(getUserMenu(menuConfig.getMenuList(), auths));
		userdetail.setUserid(user.getUserid());
		userdetail.setCnname(user.getCname());
		//机构代码
		if(user.getOrganizationCode() != null){
			userdetail.setOrganizationCode(user.getOrganizationCode());
		}
