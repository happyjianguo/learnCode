...
public class IMUserServiceImpl implements IMUserService {
	...
	public void updateImuser(IMUser imuser) throws AppException {
		...
		imuser.setUpdatetime(DateUtil.getDateTime());
		...
		if (imuser.getRoleid() != null) {
			...
			for (int i = 0; i < roles.length; i++) {
				...
				imuserrole.setUpdatetime(DateUtil.getDateTime());
				imuserrole.setCreatetime(DateUtil.getDateTime());
	...
	public void useradd(UserManageModel userManageModel) throws AppException {
		...
		imuser.setCreatetime(DateUtil.getDateTime());
		imuser.setUpdatetime(DateUtil.getDateTime());
