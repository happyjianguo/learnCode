	...
	<div class="main-content">
		<div class="list-nav">
			...
			<div class="mainbox">
				<div class="table-tit">
					<div class="tit-left" >
						<fmt:message key="recharge.hrrecharge"/>
					</div>
					<div class="tit-btn">
<!-- 								<span><button type="button" class="btn btn-primary addImuser" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus"></i>新增</button></span> -->
						<span><a href="${ctxPath}/recharge/llrecharge" class="btn btn-primary"><i class="fa fa-plus"></i><fmt:message key="recharge.llrecharge"/></a></span> 
					
					</div>											
				</div>
				<div class="mainbox">
						<div class="row">
							<form:form id="form" modelAttribute="rechargeModel" action="${ctxPath}/recharge/add" methodParam="post"
								...
								<div class="form-group">
									...
									<div class="col-sm-3 select-list" >
										<select id="cid" name="cid" class="form-control select cid" >
											...
											<c:forEach var="access" items="${rechargeModel.cfCustomerList}">
								...
								<div class="form-group">
									<div class="col-sm-offset-4 col-sm-8">
										...
										<a href="${ctxPath}/recharge/init"><button type="button" class="btn default cancel" ><fmt:message key="button.cancel"/></button></a>
									</div>
								</div>
							</form:form>
						</div>
		...
		<script type="text/javascript" >
			$(document).ready( function () {
			    ...
			    function getIpsnoValue(){
			    	$.ax({
	            		url  :"${ctxPath}/recharge/ajax/initIpsnoValue",
	            		data : {acid:$('#acid').val()},
				        successfn : function(result) { 	
...
// 			        		  	}
			    ...
			    function getprovince(){
			    	$.ax({
	            		url  :"${ctxPath}/recharge/ajax/initprovinceValue",
			    ...
			    function getfaceValue(){
		    		if($('#ispno').val() == "" ||$('#province').val() == "" || $('#acid').val() == ""){
		    			...
		    			$.ax({
		            		url  :"${ctxPath}/recharge/ajax/initFaceValue",
