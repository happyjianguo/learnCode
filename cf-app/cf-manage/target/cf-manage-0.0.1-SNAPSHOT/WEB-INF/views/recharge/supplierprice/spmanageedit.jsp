...
<title><fmt:message key="recharge.spmanageedit.title"/></title>
<!--[if lt IE 9]>
	...
	<div class="main-content">
		<div class="list-nav">
			<ol class="breadcrumb">
				...
				<li class="active" id="bill_check"><fmt:message key="recharge.spmanageedit.supplierpriceedit"/></li>
			</ol>
		</div>
		<div class="mainbox">
			<div class="row">
				<form:form id="form" modelAttribute="supplierpriceModel" action="${ctxPath}/supplierprice/editdata" methodParam="post"
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<form:input path="pname" cssClass="form-control" value="${supplierpriceModel.pname}"/>
						</div>
					</div>
					<div class="form-group">
