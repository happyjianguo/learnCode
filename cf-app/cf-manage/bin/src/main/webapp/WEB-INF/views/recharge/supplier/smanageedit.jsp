...
<title><fmt:message key="recharge.supplieredit.title"/></title>
<!--[if lt IE 9]>
	...
	<div class="main-content">
		<div class="list-nav">
			<ol class="breadcrumb">
				...
				<li class="active" id="bill_check"><fmt:message key="recharge.supplieredit.supplieredit"/></li>
			</ol>
		</div>
		<div class="mainbox">
			<div class="row">
				<form:form id="editform" modelAttribute="supplierModel" action="${ctxPath}/supplier/editdata" methodParam="post"
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<form:input path="sname" cssClass="form-control" readonly="true"/>
