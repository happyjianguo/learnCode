...
<link rel="stylesheet" type="text/css" media="all" href="<c:url value='/resources/css/fileinput.css?v=${cssv}'/>" />
<link rel="stylesheet" type="text/css" media="all" href="<c:url value='/resources/css/zTreeStyle.css?v=${cssv}'/>" />

<!-- js -->
<%-- <script type="text/javascript" src="<c:url value='/resources/js/jquery.1.11.1.js?v=${jsv}'/>"></script> --%>
...
<script type="text/javascript">
	$.extend($.fn.dataTable.defaults, {
		...
		"order" : [],
		"lengthMenu" : [ [ 10, 15, 20, 999999999 ], [ "10", "15", "20", "全部" ] ],
