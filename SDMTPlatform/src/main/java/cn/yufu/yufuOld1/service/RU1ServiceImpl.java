...
import cn.yufu.yufuOld1.dao.RUMapper;
import cn.yufu.yufuOld1.entity.RU;
import cn.yufu.yufuOld1.entity.RUExample;

@Service("yufuOld1.RU1Service")
@Transactional("transactionManagerYufuOld1")
public class RU1ServiceImpl implements RU1Service {
	Log log = Log.getLog(RU1ServiceImpl.class);

	@Autowired
	@Qualifier("yufuOld1.RUDao")
