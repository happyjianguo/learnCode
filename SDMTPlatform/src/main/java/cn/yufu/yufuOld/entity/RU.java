...
public class RU {
    ...
    private String ruacount;

    private String rulegalperson;
    ...
    public String getRuacount() {
        return ruacount;
    }

    public void setRuacount(String ruacount) {
        this.ruacount = ruacount == null ? null : ruacount.trim();
    }

    public String getRulegalperson() {
        return rulegalperson;
    }

    public void setRulegalperson(String rulegalperson) {
        this.rulegalperson = rulegalperson == null ? null : rulegalperson.trim();
    }
    ...
    public Integer getAdminbstate() {
        return adminbstate;
    }

    public void setAdminbstate(Integer adminbstate) {
        this.adminbstate = adminbstate;
    }
