...
import cn.yufu.yufuOld.dao.TerminalYufuOldMapper;
import cn.yufu.yufuOld.entity.TerminalYufuOld;
import cn.yufu.yufuOld.entity.TerminalYufuOldExample;

@Service("yufuOld.YufuOldTerminalService")
@Transactional("transactionManagerYufuOld")
public class YufuOldTerminalServiceImpl implements YufuOldTerminalService {
	Log log = Log.getLog(YufuOldTerminalServiceImpl.class);

	@Autowired
	@Qualifier("yufuOld.TerminalYufuOldDao")
