		...
		<div class="shm_contab">
			<div class="poup_right">
				<div class="shmcr_cont01">
					<div class="sh_title">修改商户补充信息</div>
					<div class="sh_cm">
						<form id="form" action="${ctx }/merchantChangeSDMT/editsaave" method="post">
							<table width="100%" border="0" class="tab">
								...
								<tr>
									...
									<td style="text-align: left;">
										<input class="inputext_style" id="merchantEname" name="merchantEname"  maxlength="20" value="${info.merchantEname}"/>								
									</td>
								...
								<tr>
									...
									<td style="text-align: left;">
										<input class="inputext_style" id="abbrEname" name="abbrEname"  maxlength="8" value="${info.abbrEname}"/>								
									</td>
								...
								<tr>
									...
									<td style="text-align: left;">
									<input class="inputext_style" id="enterpriseNo" name="enterpriseNo" maxlength="28" onkeyup="this.value=this.value.replace(/\D/g,'')" value="${info.enterpriseNo}" /></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td style="text-align: left;">
									<input class="inputext_style" id="busLicNo" name="busLicNo" maxlength="30" onkeyup="value=value.replace(/[^\w\/]/ig,'')" value="${info.busLicNo}" /></td>
								...
								<tr>
									...
									<td style="text-align: left;">
										<input class="inputext_style" id="taxId" name="taxId"  maxlength="30" onkeyup="value=value.replace(/[^\w\/]/ig,'')" value="${info.taxId}"/>								
									</td>
								</tr>								
								<tr>
									...
									<td style="text-align: left;">
										<input class="inputext_style" id="orgId" name="orgId"  maxlength="30" onkeyup="value=value.replace(/[^\w\/]/ig,'')" value="${info.orgId}"/>								
									</td>
								</tr>								
								<tr>
								...
								<tr>
									...
									<td style="text-align: left;">
									<input class="inputext_style" id="merchantCompanyName" name="merchantCompanyName" maxlength="200" value="${info.merchantCompanyName}"/></td>
