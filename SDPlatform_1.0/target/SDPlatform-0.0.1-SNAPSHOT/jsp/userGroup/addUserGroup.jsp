...
<head>
	...
	function saveClick()
	{
		document.forms[0].method.value="createGroup";
				...
				<html:form action="/UserGroup">
					...
					<table align="center" width="90%" border="0" align="center"
						...
						<tr>
							...
							<td class="table2_td">
								<html:text property="groupId" size="19" maxlength="40" />
								<font color="red">*</font>
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td align="center" colspan="2" class="table2_btn">
								<input type="image"
									src="<fmt:message key='CommonImagePath' />btnSave.gif"
					...
					<input type="hidden" name="search_name"
						value="<c:out value="${param.search_name}"/>" />
					<!-- 维护视图状态的隐藏域 -->
				</html:form>
