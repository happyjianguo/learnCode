...
<head>
	...
	function saveClick()
	{
		...
		var sss1 = document.forms[0].updateOper.value;
		var wz1=sss1.indexOf("_")
		document.forms[0].rcvBankId.value=sss1.substr(0,wz1);
	//	alert(document.forms[0].rcvBankId.value);
		return validateTranRouteForm(document.forms[0]);
		
		
	}
	function backClick()
	{
		document.forms[0].method.value="queryTranRoute";
	}
	function setMbh()
	{
...
<shiro:lacksPermission name="posp:tranroute:edit">
...
<body>
	<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="table1_border">
		...
		<tr>
			<td align="center">
				<html:javascript formName="tranRouteForm" />
				<html:errors />
				<html:form action="/tranRoute">
