...
<head>
	...
	function backClick()
	{
		document.forms[0].method.value="queryAdvRoute";
	}
	function setMbh()
	{
...
<shiro:lacksPermission name="posp:advroute:edit">
				...
				<html:form action="/advRoute">
					...
					<table align="center" width="90%" border="0" align="center" cellpadding="0" cellspacing="1" class="table2_border">
						...
						<tr>
							...
							<td class="table2_td">
								<html:text property="tranType" size="19" maxlength="64" />
