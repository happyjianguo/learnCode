...
<shiro:lacksPermission name="posp:tranmodule:edit">
		...
		<tr>
			<td align="center">
				...
				<html:form action="/tranModule">
					...
					<html:hidden property="voidTranType"/>
					<html:hidden property="voidOldTranType"/>
					<table align="center" width="90%" border="0" align="center" cellpadding="0" cellspacing="1" class="table2_border">
						...
						<tr>
							...
							<td class="table2_td">
								<html:text property="moduleId" size="19" disabled="true" onkeyup="this.value=this.value.replace(/\D/g,'')" />
								<font color="red">*</font>
							</td>
							<td class="table2_td_title">
								交易类型代码:
							...
							<td class="table2_td">
								<html:text property="tranType" size="19" disabled="true" onkeyup="this.value=this.value.replace(/\D/g,'')" />
								<font color="red">*</font>
							</td>
						</tr>
						<tr>
							...
							<td class="table2_td">
								<html:text property="voidTranType" size="19" disabled="true" onkeyup="this.value=this.value.replace(/\D/g,'')"  />
							...
							<td class="table2_td">
								<html:text property="voidOldTranType" size="19" disabled="true" onkeyup="this.value=this.value.replace(/\D/g,'')" />
