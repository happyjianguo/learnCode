...
<head>
	...
	function saveClick()
	{
		...
		if(!reg.test(rate)){
			alert("业务费率格式错误，标准格式为小数点前后不超过两位数字或两位非负整数");
			return false;
		}
...
<shiro:lacksPermission name="posp:tabBusinessRates:edit">
				...
				<html:form action="/tabBusinessRates">
					...
					<table align="center" width="90%" border="0" align="center" cellpadding="0" cellspacing="1" class="table2_border">
						<tr>
							...
							<td class="table2_td">
								<html:text property="businessid" size="30" maxlength="6" disabled="true"/>
							</td>
						</tr>
						<tr>
							<td class="table2_td_title">
