			...
			<td align="center">
				...
				<html:form action="/merchant" >
					...
					<table align="center" width="90%" border="0" align="center" cellpadding="0" cellspacing="1" class="table2_border">
						...
						<tr height="25"><td colspan="4" class="table2_td_title"><b>基本资料</b></td></tr>
						...
						<tr>
							...
							<td class="table2_td">
								<input type="text" name="cityCname" id="cityCname" size="30" maxlength="4" readonly="readonly" /><input type="button" value="选择" onclick="findArea();"><font color="red">*</font>
							</td>
							<td class="table2_td_title">
<%--								城市(英):--%>
							</td>
...
<%--								<html:text property="cityEname" size="30"  maxlength="20" />--%>
						...
						<tr height="25"><td colspan="4" class="table2_td_title" ><b>附加资料</b></td></tr>
						<tr>
							<td class="table2_td_title">
								付款人名称:
						...
						<tr height="25"><td colspan="4" class="table2_td_title"><b>退货限额控制</b></td></tr>
						<tr>
							<td class="table2_td_title">
								退货限额:
							</td>
