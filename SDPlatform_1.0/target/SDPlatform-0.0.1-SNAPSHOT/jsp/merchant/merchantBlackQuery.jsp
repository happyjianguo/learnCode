...
<shiro:lacksPermission name="posp:merchantblack:view">
    <div class="permission_error">用户[${fns:getUserName()}]没有该权限<br/></div>
</shiro:lacksPermission>
<shiro:hasPermission name="posp:merchantblack:view">
<body onload="init();">
	...
	<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="table1_border">
		...
		<tr>
			<td align="center">
				<html:form action="/merchantBlack" method="post">
					...
					<!-- 用Diaplay Tag来显示 -->
					<display:table name="pageInfoResult.resultItems" partialList="true" size="pageInfoResult.totalCount" pagesize="8" class="dpTable" id="displayTable" requestURI="/merchantBlack.do">
						...
						<display:column title="原因" style="width:18%;text-align:center" property="reason" headerClass="sortable" sortable="true" />
						<display:column title="商户状态" style="width:8%;text-align:center">
					...
					<table width="96%" border="0" align="center" cellpadding="0" cellspacing="0" class="table_border">
						<tr>
							...
							<td>
								<shiro:hasPermission name="posp:merchantblack:delete">
