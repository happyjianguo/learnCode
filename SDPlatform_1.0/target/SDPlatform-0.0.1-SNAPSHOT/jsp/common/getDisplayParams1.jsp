...
<%
//String rpname = new org.displaytag.util.ParamEncoder("officePeople").encodeParameterName(TableTagParameters.PARAMETER_PAGE);
			//System.out.println("µ±Ç°Ò³Êý£º" + rpname + " = "+ request.getParameter(rpname));
%>
