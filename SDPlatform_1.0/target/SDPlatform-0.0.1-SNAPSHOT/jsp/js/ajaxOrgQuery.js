...
var xmlHttp;
        ...
        function findMerchantNo() {
            ...
            if (inputField.value.length > 0) {                                                                          
                ...
                var url = "ajaxOrgNoAction.do?op=findno&queryValue="+escape(inputField.value)+"";                        
        ...
        function populateName2(cell) {
			...
			var w=cell.firstChild.nodeValue.indexOf("-");
			
			
			var no=cell.firstChild.nodeValue.substr(0,w);
			//alert(no);
			inputField.value = no;
