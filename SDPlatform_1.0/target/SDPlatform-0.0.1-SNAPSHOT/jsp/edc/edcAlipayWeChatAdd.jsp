...
<head>
	...
	function saveClick(){
		...
		return validateEdcAlipayWeChatForm(document.forms[0]);		
	}
	
	function backClick(){
		document.forms[0].method.value = "queryEdcAlipayWeChat";
	}
	...
	function checkMerTerMod() {	
		...
		init();
		var url="edcAlipayWeChat.do?method=checkMerTerMod&merchantId="+merchantId+"&terminalId="+terminalId+"&moduleId="+moduleId;
		req.open("POST", url, true);
...
<shiro:lacksPermission name="posp:alipaywechat:add">
...
<body>
	<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="table1_border">
		...
		<tr>
			<td align="center">
				<html:javascript formName="edcAlipayWeChatForm" />
				<html:errors />
				<html:form action="/edcAlipayWeChat">
					...
					<table align="center" width="90%" border="0" align="center" cellpadding="0" cellspacing="1" class="table2_border">
						...
						<tr>
							...
							<td class="table2_td">
								<html:text property="moduleId" size="25" value="134" readonly="true"/>
								<font color="red">*</font>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="table2_td">
								<html:select property="encMethod">
								 	<option value="7" selected="selected">MD5</option>
								</html:select>
								<font color="red">*</font>
							</td>
						</tr>
