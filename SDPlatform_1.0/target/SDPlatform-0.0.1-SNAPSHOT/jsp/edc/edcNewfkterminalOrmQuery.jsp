...
<head>
	...
	function addClick()
	{
		...
		document.forms[0].method.value="queryEdcNewfkterminalOrmByKey";
...
<shiro:lacksPermission name="posp:newterminalorm:view">
    <div class="permission_error">用户[${fns:getUserName()}]没有该权限<br/></div>
</shiro:lacksPermission>
<shiro:hasPermission name="posp:newterminalorm:view">
<body onload="init();">
	<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="table1_border">
		...
		<tr>
			<td align="center">
				<html:form action="/edcNewfkterminalOrm" method="post">
					<input type="hidden" name="method" value="queryEdcNewfkterminalOrm" />
					<!----------以下Table为查询form-------->
					<table width="96%" border="0" align="center" cellpadding="0" cellspacing="1" class="table2_border">
						...
						<tr>
							<td colspan="6" class="table2_btn">
								<input name="imageField" type="image" src="<fmt:message key='CommonImagePath' />btnQuery.gif" alt="查询" width="65" height="20" border="0" onclick="return searchClick('queryEdcNewfkterminalOrm');">
					...
					<!-- 用Diaplay Tag来显示 -->
					<display:table name="pageInfoResult.resultItems" partialList="true" size="pageInfoResult.totalCount" pagesize="8" class="dpTable" id="displayTable" requestURI="/edcNewfkterminalOrm.do">
                        ...
                        <shiro:hasPermission name="posp:newterminalorm:view">
						   <a href="#" onclick="javascript:editClicks('<c:out value="${displayTable.merchantId}#${displayTable.terminalId}#${displayTable.moduleId}#end"/>','queryEdcNewfkterminalOrmByKey')">查看</a>
                        </shiro:hasPermission> 
						</display:column>
					...
					<table width="96%" border="0" align="center" cellpadding="0" cellspacing="0" class="table_border">
						<tr>
							...
							<td>
                                <shiro:hasPermission name="posp:newterminalorm:delete">
								<a href="javascript:deleteClick('selectItems','checkItem','deleteEdcNewfkterminalOrm');"><img border=0 name="imageField33" src="<fmt:message key='CommonImagePath' />btnDelete.gif" alt="删除" width="65" height="20" border="0"></a>
                                </shiro:hasPermission>
	...
	<shiro:hasPermission name="posp:newterminalorm:upload">
	<center>			
	<form id='formShowData' name="formShowData" enctype='multipart/form-data' method='post' action="edcNewfkterminalOrmUpload.do" >
