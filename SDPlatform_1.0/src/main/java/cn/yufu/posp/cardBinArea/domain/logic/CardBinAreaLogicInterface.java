...
public interface CardBinAreaLogicInterface {

	// 查找所有记录
	public PageInfoModel queryAll(CardBinArea newQueryModel, PageInfoModel newPageInfoModel, UserData ud) throws OAException;
