...
public class EdcTerminalOrmForm extends BaseForm {
	...
	private String queryBankTerminalId;
	private String queryLogonStatus;
	...
	public String getQueryBankTerminalId() {
		return queryBankTerminalId;
	}

	public void setQueryBankTerminalId(String queryBankTerminalId) {
		this.queryBankTerminalId = queryBankTerminalId;
	}

	public String getQueryLogonStatus() {
		return queryLogonStatus;
	}

	public void setQueryLogonStatus(String queryLogonStatus) {
		this.queryLogonStatus = queryLogonStatus;
	}
