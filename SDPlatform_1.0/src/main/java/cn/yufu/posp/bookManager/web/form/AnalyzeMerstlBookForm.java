...
public class AnalyzeMerstlBookForm extends BaseForm {
	...
	/** default constructor */
	public AnalyzeMerstlBookForm() {
	}

	/** minimal constructor */
	public AnalyzeMerstlBookForm(String id, Date gentime, String merno, String stldate) {
		this.id = id;
	...
	/** full constructor */
	public AnalyzeMerstlBookForm(String id, Date gentime, String merno, String stldate, String stlstartdate, String stlenddate, BigDecimal status,
