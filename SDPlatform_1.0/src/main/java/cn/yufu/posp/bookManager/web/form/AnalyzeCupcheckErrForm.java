...
/**
 * AnalyzeCupcheckErr entity. @author MyEclipse Persistence Tools
 */

public class AnalyzeCupcheckErrForm extends BaseForm {
	...
	/** default constructor */
	public AnalyzeCupcheckErrForm() {
	}

	/** minimal constructor */
	public AnalyzeCupcheckErrForm(String bookid, String cardNo, BigDecimal tranType, String localSysDate, String localSysTime, Double tranAmt,
			BigDecimal hostLsNo, String bankType, String cardType, String ccyCode, String acqBankId, String acqHostId, String issBankId, String sndSettleFlag,
			String rcvSettleFlag, String agtSettleFlag, String advSettleFlag, String tranFlag) {
		this.bookid = bookid;
		this.cardNo = cardNo;
	...
	/** full constructor */
	public AnalyzeCupcheckErrForm(String bookid, BigDecimal checkFlag, String checkDate, String cardNo, String expDate, BigDecimal tranType,
			BigDecimal voidTranType, BigDecimal voidOldTranType, String localSysDate, String localSysTime, String tranSysTime, Double tranAmt, Double voidAmt,
			String terminalId, String merchantId, String merchantName, String mcc, BigDecimal traceNo, BigDecimal voidTraceNo, String tranRrn, String voidRrn,
