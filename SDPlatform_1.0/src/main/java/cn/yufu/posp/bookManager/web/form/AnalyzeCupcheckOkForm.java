...
public class AnalyzeCupcheckOkForm extends BaseForm {
	...
	/** default constructor */
	public AnalyzeCupcheckOkForm() {
	}

	/** minimal constructor */
	public AnalyzeCupcheckOkForm(String id, String cardNo, BigDecimal tranType, String localSysDate, String localSysTime, Double tranAmt, BigDecimal hostLsNo,
	...
	/** full constructor */
	public AnalyzeCupcheckOkForm(String id, BigDecimal checkFlag, String checkDate, String cardNo, String expDate, BigDecimal tranType,
