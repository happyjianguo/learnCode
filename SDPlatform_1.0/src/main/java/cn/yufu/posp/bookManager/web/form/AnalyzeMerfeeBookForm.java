...
public class AnalyzeMerfeeBookForm extends BaseForm {
	...
	/** default constructor */
	public AnalyzeMerfeeBookForm() {
	}

	/** minimal constructor */
	public AnalyzeMerfeeBookForm(String id, Date gentime, String merno, String bookdate, String cyclestartdate, String cycleenddate) {
		this.id = id;
	...
	/** full constructor */
	public AnalyzeMerfeeBookForm(String id, Date gentime, String merno, String bookdate, String cyclestartdate, String cycleenddate, BigDecimal status,
