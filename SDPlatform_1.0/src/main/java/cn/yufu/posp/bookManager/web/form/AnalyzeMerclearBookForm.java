...
public class AnalyzeMerclearBookForm extends BaseForm {
	...
	/** default constructor */
	public AnalyzeMerclearBookForm() {
	}

	/** minimal constructor */
	public AnalyzeMerclearBookForm(String id, Date gentime, String trandate, String merno) {
		this.id = id;
	...
	/** full constructor */
	public AnalyzeMerclearBookForm(String id, Date gentime, String trandate, String merno, BigDecimal trannum, BigDecimal tranamt, BigDecimal refundnum,
