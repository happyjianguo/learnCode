...
public class AnalyzeCupcheckBookForm extends BaseForm {
	...
	/** default constructor */
	public AnalyzeCupcheckBookForm() {
	}

	/** minimal constructor */
	public AnalyzeCupcheckBookForm(String bookid, Date gentasktime, String filedate, String comafilename, String errafilename, String lfefilename,
			BigDecimal status) {
		this.bookid = bookid;
