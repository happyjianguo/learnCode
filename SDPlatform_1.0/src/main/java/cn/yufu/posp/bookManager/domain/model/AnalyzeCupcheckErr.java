...
public class AnalyzeCupcheckErr implements java.io.Serializable {
	...
	/** default constructor */
	public AnalyzeCupcheckErr() {
	}

	/** minimal constructor */
	public AnalyzeCupcheckErr(String bookid, String cardNo, BigDecimal tranType, String localSysDate, String localSysTime, Double tranAmt, BigDecimal hostLsNo,
	...
	/** full constructor */
	public AnalyzeCupcheckErr(String bookid, BigDecimal checkFlag, String checkDate, String cardNo, String expDate, BigDecimal tranType,
