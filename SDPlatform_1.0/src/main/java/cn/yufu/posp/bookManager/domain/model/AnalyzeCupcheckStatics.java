...
public class AnalyzeCupcheckStatics implements java.io.Serializable {
	...
	/** default constructor */
	public AnalyzeCupcheckStatics() {
	}

	/** minimal constructor */
	public AnalyzeCupcheckStatics(String bookid, String filedate) {
		this.bookid = bookid;
		this.filedate = filedate;
	}

	/** full constructor */
	public AnalyzeCupcheckStatics(String bookid, String filedate, String checkDate, BigDecimal sysCurCheckTotalNum, BigDecimal sysCurCheckTotalAmt,
