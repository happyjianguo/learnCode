...
<shiro:lacksPermission name="posp:alipaywechat:view">
...
<body onload="init();">
	<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="table1_border">
		...
		<tr>
			<td align="center">
				<html:form action="/edcAlipayWeChat" method="post">
					<input type="hidden" name="method" value="queryEdcAlipayWeChat" />
					<!----------以下Table为查询form-------->
					<table width="96%" border="0" align="center" cellpadding="0" cellspacing="1" class="table2_border">
						...
						<tr>
							<td colspan="6" class="table2_btn">
								<input name="imageField" type="image" src="<fmt:message key='CommonImagePath' />btnQuery.gif" alt="查询" width="65" height="20" border="0" onclick="return searchClick('queryEdcAlipayWeChat');">
					...
					<!-- 用Diaplay Tag来显示 -->
					<display:table name="pageInfoResult.resultItems" partialList="true" size="pageInfoResult.totalCount" pagesize="8" class="dpTable" id="displayTable" requestURI="/edcAlipayWeChat.do">
					...
					<table width="96%" border="0" align="center" cellpadding="0" cellspacing="0" class="table_border">
						<tr>
							...
							<td>
                                <shiro:hasPermission name="posp:alipaywechat:delete">
                                ...
                                <shiro:hasPermission name="posp:alipaywechat:add">
	...
	<shiro:hasPermission name="posp:alipaywechat:upload">
		<center>			
			<form id='formShowData' name="formShowData" enctype='multipart/form-data' method='post' action="edcAlipayWeChatUpload.do" >
