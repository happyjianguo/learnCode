...
<shiro:lacksPermission name="posp:stlmRegu:add">
				...
				<html:form action="/stlmRegu" method="post">
					...
					<table align="center" width="90%" border="0" align="center" cellpadding="0" cellspacing="1" class="table2_border">
						<tr>
							...
							<td class="table2_td">
								<html:text property="ruleNo" size="30" maxlength="7"  /><font color="red">*</font>
							</td>
							<td class="table2_td_title">
								 优先级(越大优先级越高):
							</td>
						...
						<tr>
							...
							<td class="table2_td">
								<html:text property="endDate" size="30" maxlength="8" value="20991231" onclick="WdatePicker({dateFmt:'yyyyMMdd'})"/><font color="red">*</font>
							</td>
						</tr>
						<tr>
							<td class="table2_td_title">
							...
							<td class="table2_td">
							<html:select property="channelNo" style="width:130px;" value="">
							...
							<td class="table2_td">
							<html:select property="cardType" style="width:130px;" value="">
								<html:option value="">-请选择-</html:option>
						...
						<tr>
							...
							<td class="table2_td">
							<html:select property="transCode" style="width:130px;" value="">
						...
						<tr>
							...
							<td class="table2_td">
							<html:select property="mchtFlg" style="width:130px;" value="">
								<html:option value="">-请选择-</html:option>
						...
						<tr>
							...
							<td class="table2_td">
							<html:select property="g1CrDscFlg" style="width:130px;" value="">
								<html:option value="">-请选择-</html:option>
