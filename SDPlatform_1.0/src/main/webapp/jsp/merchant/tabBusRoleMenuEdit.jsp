...
<script language="javascript">
	...
	function initFlag()
	{
 		busRoleNameTemp=document.forms[0].busRoleName.value;
	}
	...
	function findBusRoleNameKey(){
 		...
 		if(busRoleNameTemp!=busRoleName){
	 	  	init();
...
<shiro:lacksPermission name="posp:tabBusRoleMenu:edit">
    <div class="permission_error">用户[${fns:getUserName()}]没有该权限<br/></div>
</shiro:lacksPermission>
<shiro:hasPermission name="posp:tabBusRoleMenu:edit">
<body onload="initFlag()">
	<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="table1_border">
		<tr>
			<td class="table1_head_title"><img src="<fmt:message key='CommonImagePath' />table1_head_ico.gif" width="26" height="23" align="absmiddle"> 修改业务角色菜单</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<html:form action="/tabBusRoleMenu">
					...
					<table align="center" width="90%" border="0" align="center" cellpadding="0" cellspacing="1" class="table2_border">
						...
						<tr>
							...
							<td class="table2_td">
								...
								<c:forEach items="${tabBusinessRatesList}" var="tabBusinessRatesMap" varStatus="index">
									${tabBusinessRatesMap.businessid }、<input type="checkbox" name="tabBusinessRatesMap${tabBusinessRatesMap.businessid }" id="tabBusinessRatesMap${tabBusinessRatesMap.businessid }" 
										<c:forEach items="${fn:split(tabBusRoleMenuForm.menuList,',')}" var="tabBusRoleMenuFormMenuList" varStatus="indexMenuList">
											<c:if test="${tabBusRoleMenuFormMenuList eq tabBusinessRatesMap.businessid }">
											checked="checked"
											</c:if>
										</c:forEach>
									>${tabBusinessRatesMap.businessname } <br>	
								</c:forEach>
								 <font color="red">*</font>
						...
						<html:hidden property="busRoleId"/>
