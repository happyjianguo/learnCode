...
<head>
	...
	function saveClick()
	{
		document.forms[0].method.value="check";
...
<shiro:lacksPermission name="posp:merchantCheck:edit">
    <div class="permission_error">用户[${fns:getUserName()}]没有该权限<br/></div>
</shiro:lacksPermission>
<shiro:hasPermission name="posp:merchantCheck:edit">
<body>
	<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="table1_border">
		...
		<tr>
			<td align="center">
				...
				<html:errors />
				<html:form action="/merchantCheck">
					...
					<table align="center" width="90%" border="0" align="center" cellpadding="0" cellspacing="1" class="table2_border">
						...
						<tr>
							...
							<td class="table2_td">
								<input type="text" name="mcc" value="${merchantBoForm.mcc}" id="mcc" size="30"  maxlength="4" onclick="findMccParam();" onkeyup="this.value=this.value.replace(/\D/g,'');findMccParam();" onblur="closeDiv();" /><font color="red">*</font>
							</td>
						</tr>
						<tr>
							<td class="table2_td_title">
							...
							<td class="table2_td">
								<html:text property="merchantCname" size="30" maxlength="40" onfocus="this.value=this.value.RTrim()"/><font color="red">*</font>
							</td>
							<td class="table2_td_title">
								简称(中):
							</td>
							<td class="table2_td">
								<html:text property="abbrCname" size="30"  maxlength="12" onfocus="this.value=this.value.RTrim()" />
							</td>
						</tr>
						<tr>
							<td class="table2_td_title">
						...
						<tr>
							...
							<td class="table2_td">
								<html:text property="addressChn"  size="30" maxlength="30" onfocus="this.value=this.value.RTrim()"/>
							</td>
							<td class="table2_td_title">
								地址(英):
							</td>
...
<%--								<html:text property="cityEname" size="30" maxlength="20" onfocus="this.value=this.value.RTrim()"/>--%>
						...
						<tr>
							...
							<td class="table2_td">
								<html:text property="manager" size="30" maxlength="8" onfocus="this.value=this.value.RTrim()"/>
							</td>
							<td class="table2_td_title">
								邮政编码:
							</td>
						...
						<tr>
							...
							<td class="table2_td">
								<input name="signBankId" onclick="findNames();" id="signBankId" value="${merchantBoForm.signBankId}" size="30" onblur="closeDiv();" maxlength="11" onkeyup="this.value=this.value.replace(/\D/g,'');findNames();"/><font color="red">*</font>
						...
						<tr>
							...
							<td class="table2_td">
								<html:text property="sndName" size="30" maxlength="40"  onfocus="this.value=this.value.RTrim()"/>
							</td>
							<td class="table2_td_title">
								付款人账号:
							</td>
						...
						<tr>
							...
							<td class="table2_td">
								<html:text property="sndBank" size="30" maxlength="30" onfocus="this.value=this.value.RTrim()"/>
							</td>
							<td class="table2_td_title">
							</td>
							<td class="table2_td">
						...
						<tr>
							...
							<td class="table2_td">
								<html:text property="rcvName" size="30"  maxlength="40" onfocus="this.value=this.value.RTrim()"/>
							</td>
							<td class="table2_td_title">
								收款人账号1:
							</td>
						...
						<tr>
							...
							<td class="table2_td">
								<html:text property="rcvBank"  size="30" maxlength="30" onfocus="this.value=this.value.RTrim()"/>
							</td>
						</tr>
						<tr height="25" class="table2_td_title"><td colspan="4"><b>审核信息</b></td></tr>
						<tr>
							<td class="table2_td_title">
								意见:
							</td>
							<td class="table2_td">
								...
								<html:option value="Y">通过</html:option>
								<html:option value="N">驳回</html:option>
								</html:select>
							</td>
							<td class="table2_td_title">
								原因:
						...
						<tr>
							<td align="center" colspan="4" class="table2_btn">
								<input type="image" src="<fmt:message key='CommonImagePath' />btnSubmit.gif" onclick="return saveClick()">
								&nbsp;
