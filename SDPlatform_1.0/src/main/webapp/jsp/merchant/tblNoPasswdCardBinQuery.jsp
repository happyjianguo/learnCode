			...
			<td align="center">
				<html:form action="/tblNoPasswdCardBin" method="post">
					...
					<display:table name="pageInfoResult.resultItems" partialList="true" size="pageInfoResult.totalCount" pagesize="8" class="dpTable" id="displayTable" requestURI="/tblMerchantTranParam.do">
						...
						<display:column title="卡信息" style="width:15%;text-align:center" property="cardBinInfo" headerClass="sortable" sortable="true" />
						<display:column title="卡信息长度（位）" style="width:15%;text-align:center" property="dataLength" headerClass="sortable" sortable="true" />
						...
						<display:column title="记录是否有效" style="width:15%;text-align:center" headerClass="sortable" sortable="true">
						...
						<shiro:hasPermission name="posp:tblNoPasswdCardBin:edit">
							<a href="#" onclick="editClicks('<c:out value="${displayTable.cardBinInfo}"/>','findItem')">编辑</a>
						</shiro:hasPermission>
						</display:column>
					</display:table>
					<!-- 用Diaplay Tag来显示 -->		
