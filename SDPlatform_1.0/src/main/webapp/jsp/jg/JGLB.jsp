			...
			<td align="center">
				<html:form action="/Jg" method="post">
					...
					<table width="96%" border="0" align="center" cellpadding="0" cellspacing="1" class="table2_border">
						...
						<tr>
							<td colspan="4" class="table2_btn">
								<input name="imageField" type="image" src="<fmt:message key='CommonImagePath' />btnQuery.gif" alt="查询" width="65" height="20" border="0" onclick="return searchClick('queryJg');">
					...
					<display:table name="pageInfoResult.resultItems" partialList="true" size="pageInfoResult.totalCount" pagesize="8" class="dpTable" id="displayTable" requestURI="/Jg.do">
						<display:column title="选择" style="width:20%;text-align:center">
							
						<input type="checkbox" name="checkItem" value="<c:out value="${displayTable.jgId}"/>">
							
						</display:column>
						<display:column title="机构代码" style="width:20%;text-align:center" property="jgId" headerClass="sortable" sortable="true" />
						<display:column title="机构名称" style="width:20%;text-align:center" property="jgName" headerClass="sortable" sortable="true" />
						<display:column title="操作" style="width:20%;text-align:center">
 						<shiro:hasPermission name="posp:Jg:edit">
							<a href="#" onclick="editClicks('<c:out value="${displayTable.jgId}"/>','queryJgByKey')">编辑</a>
						</shiro:hasPermission>
						</display:column>
						...
						<tr>
							...
							<td>
								<shiro:hasPermission name="posp:Jg:delete">
									<a href="#"><img border=0 name="imageField33" src="<fmt:message key='CommonImagePath' />btnDelete.gif" alt="删除" width="65" height="20" border="0" onclick="deleteClick('selectItems','checkItem','deleteJg');"></a>
								</shiro:hasPermission>
