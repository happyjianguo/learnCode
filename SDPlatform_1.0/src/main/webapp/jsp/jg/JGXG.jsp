...
<head>
	...
	function saveClick()
	{
		document.forms[0].method.value="saveJg";
...
<shiro:lacksPermission name="posp:Jg:edit">
		...
		<tr>
			<td align="center">
				...
				<html:form action="/Jg">
					...
					<html:hidden property="method" value="saveJg" />
					...
					<table align="center" width="90%" border="0" align="center" cellpadding="0" cellspacing="1" class="table2_border">
						...
						<tr>
							...
							<td class="table2_td">
								<html:text property="jgId" size="19" maxlength="10" disabled="true"/>
								<font color="red">*</font>
