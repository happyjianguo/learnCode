...
<head>
	...
	function saveClick()
	{
		...
		return validateSysModuleOtherForm(document.forms[0]);
...
<shiro:lacksPermission name="posp:sysModuleOther:edit">
...
<body>
	<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="table1_border">
		...
		<tr>
			<td align="center">
				<html:javascript formName="sysModuleOtherForm" />
				<html:errors />
				<html:form action="/sysModuleOther">
