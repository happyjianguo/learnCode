...
<shiro:lacksPermission name="posp:sysModuleOther:view">
    <div class="permission_error">用户[${fns:getUserName()}]没有该权限<br/></div>
</shiro:lacksPermission>
<shiro:hasPermission name="posp:sysModuleOther:view">
<body onload="init();">
	<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="table1_border">
		...
		<tr>
			<td align="center">
				<html:form action="/sysModuleOther" method="post">
					...
					<!-- 用Diaplay Tag来显示 -->
					<display:table name="pageInfoResult.resultItems" partialList="true" size="pageInfoResult.totalCount" pagesize="8" class="dpTable" id="displayTable" requestURI="/sysModuleOther.do">
						...
						<shiro:hasPermission name="posp:sysModuleOther:edit">
					...
					<table width="96%" border="0" align="center" cellpadding="0" cellspacing="0" class="table_border">
						<tr>
							...
							<td>
								<shiro:hasPermission name="posp:sysModuleOther:delete">
								...
								<shiro:hasPermission name="posp:sysModuleOther:add">
