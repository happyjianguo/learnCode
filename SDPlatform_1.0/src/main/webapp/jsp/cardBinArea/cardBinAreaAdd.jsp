...
<head>
	...
	function saveClick()
	{
		var cardBin=document.forms[0].cardBin.value;
		if(cardBin!=null&&cardBin!=''&&cardBin.length!=9){
			alert("卡BIN不能为空且必须是9位"); 
			document.forms[0].cardBin.focus();
			return false;
		}
...
<shiro:lacksPermission name="posp:cardBinArea:add">
				...
				<html:form action="/cardBinArea" method="post">
					...
					<table align="center" width="90%" border="0" align="center" cellpadding="0" cellspacing="1" class="table2_border">
						<tr>
							...
							<td class="table2_td">
								<html:text property="cardBin" size="30" maxlength="9" onkeyup="this.value=this.value.replace(/\D/g,'')" /><font color="red">*</font>
							</td>
						</tr>
						<tr>							
							<td class="table2_td_title">
							...
							<td class="table2_td">
								<input type="text" name="areaCode" id="areaCode" size="30" maxlength="4" readonly="readonly" />
