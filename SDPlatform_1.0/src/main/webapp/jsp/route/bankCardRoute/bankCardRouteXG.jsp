...
<head>
	...
	function saveClick()
	{
		document.forms[0].method.value="saveBankCardRoute";
		return validateBankCardRouteForm(document.forms[0]);
		
	}
	function backClick()
	{
		document.forms[0].method.value="queryBankCardRoute";
	}
	function setMbh()
	{
...
<shiro:lacksPermission name="posp:bankcardroute:edit">
...
<body>
	<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="table1_border">
		...
		<tr>
			<td align="center">
				<html:javascript formName="bankCardRouteForm" />
				<html:errors />
				<html:form action="/bankCardRoute">

					<html:hidden property="method" value="saveBankCardRoute" />
