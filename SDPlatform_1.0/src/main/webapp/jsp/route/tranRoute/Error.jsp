...
<table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0" class="table1_border">
  ...
  <tr>
    <td><table width="96%" border="0" align="center" cellpadding="0" cellspacing="0" class="table_border">
        <tr>
          <td height="50" align="center"><img src="<c:out value="${pageContext.request.contextPath}" />/<fmt:message key='CommonImagePath' />icoPrompt.gif" width="37" height="33" align="absmiddle"><font color="#FF0000">对不起，操作失败。请检查交易位图与银行类型是否已存在！</font></td>
        </tr>
      </table></td>
  </tr>
</table>
