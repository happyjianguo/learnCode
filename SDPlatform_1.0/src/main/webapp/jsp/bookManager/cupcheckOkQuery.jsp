...
<head>
	...
	{
		window.showModalDialog("cupcheckOk.do?method=queryDetail&read=true&id="+id, "_blank", 'dialogWidth=800px;dialogHeight=440px;scroll=yes;resizable=no;status=no;center=yes;');
	}
...
<body onload="init()">
	...
	<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="table1_border">
		...
		<tr>
			<td align="center">
				<html:errors />
				<html:form action="/cupcheckOk" method="post">
					...
					<!-- 用Diaplay Tag来显示 -->
					<display:table name="pageInfoResult.resultItems" partialList="true" size="pageInfoResult.totalCount" pagesize="8" class="dpTable" id="displayTable" requestURI="/cupcheckOk.do">
						...
						<c:if test="${currentUserData.groupMap.x010906x00=='yes'}"> 
