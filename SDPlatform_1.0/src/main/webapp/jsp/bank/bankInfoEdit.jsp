...
<shiro:lacksPermission name="posp:bankinfo:edit">
				...
				<html:form action="/bankInfo" method="post">
					...
					<table align="center" width="90%" border="0" align="center" cellpadding="0" cellspacing="1" class="table2_border">
						<tr>
							...
							<td class="table2_td">
								<html:text property="bankId" size="30" disabled="true" maxlength="11" onkeyup="this.value=this.value.replace(/\D/g,'')" /><font color="red">*</font>
