...
function exportExcel(cardStatus) {
	...
	$("#form").attr("action","${pageContext.request.contextPath}/ClearStatDailyAccdet/exportExcel?cardStatus="+cardStatus);
	$("#form").submit();
}
function query(cardStatus) {
	var begainDailyDate = $("#begainDailyDate").val();
	var endDailyDate = $("#endDailyDate").val();
	...
	$("#form").attr("action","${pageContext.request.contextPath}/ClearStatDailyAccdet/getList?cardStatus="+cardStatus);
	$("#form").submit();
}	
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								...
								<tr>									
									...
									<td style="text-align: center;" colspan="2">
											...
											<input type="button" value="查询" class="button" onclick="query('<c:out value="${query.cardStatus }"/>')"/>
											<input type="button" value="导出" class="button" onclick="exportExcel('<c:out value="${query.cardStatus }"/>')" />
							...
							<c:if test="${ ClearStatDailyAccdetList != null  }">
								<tr>
									<td colspan="18" style="text-align: center">
										...
										&nbsp;&nbsp;&nbsp;&nbsp;联名卡积分账户:<fmt:formatNumber value="${total_acc_sum}" pattern="#,###,###,###,###,##0.##" minFractionDigits="2" ></fmt:formatNumber>
