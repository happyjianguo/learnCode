...
<body onload="form.comments1.focus();">
	<div class="sh_main">
		<div class="shm_contab">
			<div class="poup_right">
				<div class="shmcr_cont01">
					<div class="sh_title">第一次审核差错流水信息</div>
					<div class="sh_cm">
						<form id="form" action="${pageContext.request.contextPath}/ClearCheckErr/firstCheck" method="post">
							<table width="100%" border="0" class="tab">
								...
								<tr>
									...
									<td style="text-align: left;">
										<select id="adjustFlag" name="adjustFlag" class="inputext_style">									
								...
								<tr>	
									...
									<td style="text-align: left;">	
										<textarea rows="5" cols="25" id="comments1" name="comments1" maxlength="50"></textarea>
									</td>									
								</tr>																									
								<tr>
