...
public class ClearMerStlFinalBookBak {
    private String id;
    ...
    private String startStlDateN;			//节假日最早开始交易日（根据T_COMBINE_DATE）
    
    private String endStlDateN;			//节假日最早开始交易日（根据T_COMBINE_DATE）
    
    private String combineFlag;			//节假日结算日期是否合并（0-不合并,1-合并；默认：0-不合并）
	...
	public String getStartStlDateN() {
		return startStlDateN;
	}

	public void setStartStlDateN(String startStlDateN) {
		this.startStlDateN = startStlDateN;
	}

	public String getEndStlDateN() {
		return endStlDateN;
	}

	public void setEndStlDateN(String endStlDateN) {
		this.endStlDateN = endStlDateN;
	}
