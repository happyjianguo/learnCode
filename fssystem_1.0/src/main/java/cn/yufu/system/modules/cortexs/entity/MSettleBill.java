...
public class MSettleBill extends DataEntity<MSettleBill> {
    ...
    public String getLastKpDate() {
        return lastKpDate;
    }

    public void setLastKpDate(String lastKpDate) {
