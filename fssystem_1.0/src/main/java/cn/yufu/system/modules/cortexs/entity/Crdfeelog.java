...
public class Crdfeelog extends DataEntity<Crdfeelog>{
    ...
    private Integer txncode;	//交易码  0 消费  20 退款
    ...
    private String reserved1;	//退款状态  0-正常；1-退款

    private String reserved2;	//退款时间 
    ...
    private String refundIDs;  //退款数据ID集合
    
    private List<String> ids;  	//退款数据ID集合
