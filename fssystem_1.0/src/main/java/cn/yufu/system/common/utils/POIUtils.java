...
public class POIUtils {
	...
	/**
	 * 设置格式
	 * @param style 要设置格式的style
	 * @param cellBackgroundColor  单元格背景色
	 * @param font  
	 * @param fontStyle  字体样式  "宋体、黑体"
	 * @param fontSize  字体大小
	 * @param border  边框宽度
	 * @return
	 */
	public static HSSFCellStyle setStyle(HSSFWorkbook work ,short cellBackgroundColor, String fontStyle,short fontSize, short border) {
		
		HSSFCellStyle style=work.createCellStyle();
		HSSFFont font = work.createFont(); 
		
		style.setFillForegroundColor(cellBackgroundColor);
