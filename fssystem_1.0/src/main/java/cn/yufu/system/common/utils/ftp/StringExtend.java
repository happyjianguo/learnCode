...
public class StringExtend {
	 ...
	 * 参数格式：ArgumentIndex[,FormatType[,FormatStyle]] </br> FormatType
	 * 取值:number,date，time，choice </br> FormatType 样式：如：#.## </br> 注：'{'
	 * 可输出左花括号(单写左花括号会报错，而单写右花括号将正常输出)</br>
	 * 
	 * @param msg
	 *            格式化模板
	 * @param args
	...
	public static boolean getBoolean(String str) {
		...
		Pattern pattern = Pattern.compile("(1)|(true)",
