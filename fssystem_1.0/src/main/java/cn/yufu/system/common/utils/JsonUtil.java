...
/**
 * Json-lib的封装类，实现json字符串与json对象之间的转换 网友johncon提供稍作修改
 * 
 * modify： 2014-09-10 mengfp :增加NUMBER_NULL_JSONCONF,处理Number的子类null会默认转为0的问题
 * 
 * @author zhaoxin
 *
 */
public class JsonUtil {
	private static Log log = Log.getLog(JsonUtil.class);
