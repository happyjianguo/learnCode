	...
	*/
	...
	{
	    var phoneRegWithArea = /^(13[0-9]|15[0-9]|18[7|8|9|6|5])\d{4,8}$/;
	...
	*/
	...
	{
	    var bankCardNumberArea = /^\d{15,19}$/;
	    if (bankCardNumberArea.test(bankCardNumber)) {
	        return true;
	    } 
	    return false;
	};
	...
	返回：如果通过验证返回true,否则返回false
	*/
	function checkCvn2( cvn2 )
	{
	    var cvn2Area = /^\d{3}$/;
	    if ( cvn2Area.test(cvn2) ) {
	        return true;
	    } 
	    return false;
	};
	...
	返回：如果通过验证返回true,否则返回false
	*/
	function checkCardnumDate( cardnumDate )
	{
	    var cardnumDateArea = /^\d{2}\/\d{2}$/;
	    if ( cardnumDateArea.test(cardnumDate) ) {
	        return true;
	    } 
	    return false;
	};
