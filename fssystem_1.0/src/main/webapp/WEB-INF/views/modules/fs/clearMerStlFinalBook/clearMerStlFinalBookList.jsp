...
<script type="text/javascript">
	...
	function exportExcel(flag) {
		//alert("/ClearMerStlFinalBook/exportExcel?flagOnline="+flag)
		$("#form").attr("action","${pageContext.request.contextPath}/ClearMerStlFinalBook/exportExcel?flagOnline="+flag);
		$("#form").submit();
	}
	function exportExcelYL(flag) {
		$("#form").attr("action","${pageContext.request.contextPath}/ClearMerStlFinalBook/exportExcelYL?flagOnline="+flag);
		$("#form").submit();
	}
	
	function query(flag){
		$("#form").attr("action","${pageContext.request.contextPath}/ClearMerStlFinalBook/getList?flagOnline="+flag);
	...
	function batchPrint() {
		...
		var url = '${pageContext.request.contextPath}/ClearMerStlFinalBook/batchPrint?merNo='+$("#merNo").val()+"&merName="+$("#merName").val()+
    ...
    var shenhe =function (type, online) { 
        ...
        url='${pageContext.request.contextPath}/ClearMerStlFinalBook/shenhe';
		//alert("url:"+url);		
		$.ajax({
			url : url,
			type : "post",
		...
		<div class="shm_contab">
			<div class="poup_right">
				<div class="shmcr_cont01">
					...
					<div class="shmc_tab2">
						<form id="form" action="${pageContext.request.contextPath}/ClearMerStlFinalBook/getList" method="post">
