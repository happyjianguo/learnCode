...
$(document).ready(function() {
		$('#exportExcel').click(function() {
			$("#form").attr("action","${pageContext.request.contextPath}/ClearMerStlFinalBook/exportExcelPC");
			$("#form").submit();
		});		
	});
	function query(){
		$("#form").attr("action","${pageContext.request.contextPath}/ClearMerStlFinalBook/getListPC");
		...
		<div class="shm_contab">
			<div class="poup_right">
				<div class="shmcr_cont01">
					...
					<div class="shmc_tab2">
						<form id="form" action="${pageContext.request.contextPath}/ClearMerStlFinalBook/getListPC" method="post">
