...
$(document).ready(function() {
		$('#exportExcel').click(function() {
			...
			$("#form").attr("action","${pageContext.request.contextPath}/ClearMerClearBook/exportExcelOfPaiMingTotal");
			$("#form").submit();
		});
		$('#query').click(function() {
			...
			$("#form").attr("action","${pageContext.request.contextPath}/ClearMerClearBook/getListOfPaiMingTotal");
			$("#form").submit();
		});		
	});
		...
		<div class="shm_contab">
			<div class="poup_right">
				<div class="shmcr_cont01">
					<div class="sh_title">商户消费排名汇总</div>
					<div class="shmc_tab2">
						<form id="form" action="${pageContext.request.contextPath}/ClearMerClearBook/getListOfPaiMingTotal" method="post">
