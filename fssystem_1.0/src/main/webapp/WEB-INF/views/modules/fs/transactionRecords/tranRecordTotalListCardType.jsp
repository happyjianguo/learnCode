						...
						<div class="shmc_tab2">
							<form id="form" action="${pageContext.request.contextPath}/tranRecordTotal/list"
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									...
									<tr>
										...
										<td id="tdLable" style="text-align: right;">卡类型：</td>
										...
										<td id="tdLable1" style="text-align: right;"></td>
										<td id="tdText1" style="text-align: left;"></td>
									</tr>
									<tr>
							...
							<table width="100%" border="1" cellspacing="0" cellpadding="0">
								<tr>
									...
									<th style="text-align: center;">卡类型编号</th>
									<th style="text-align: center;">卡类型名称</th>
