...
<script type="text/javascript">
	function exportExcel(flag) {
		$("#form").attr("action","${pageContext.request.contextPath}/ClearMerStlBook/exportExcel?flagOnline="+flag);
		$("#form").submit();
	}
	
	function query(flag) {
		$("#form").attr("action","${pageContext.request.contextPath}/ClearMerStlBook/getList?flagOnline="+flag);
