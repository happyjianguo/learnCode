...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#exportExcel').click(function() {
			$("#form").attr("action","${pageContext.request.contextPath}/NewCrdinfoRealName/exportExcel");
			$("#form").submit();
		});
		
		$('#exportExcelAll').click(function() {
			$("#form").attr("action","${pageContext.request.contextPath}/NewCrdinfoRealName/exportExcelAll");
			$("#form").submit();
		});
		
		$('#query').click(function() {
			$("#form").attr("action","${pageContext.request.contextPath}/NewCrdinfoRealName/list");
			$("#form").submit();
		});		
	});	
			...
			<div class="shm_contab">
				<div class="poup_right">
					<div class="shmcr_cont01">
						...
						<div class="shmc_tab2">
							<form id="form" action="${pageContext.request.contextPath}/NewCrdinfoRealName/list"
								method="post">
							...
							<table width="100%" border="1" cellspacing="0" cellpadding="0">
								...
								<c:if test="${newCrdinfoList != null}">
									<c:forEach items="${newCrdinfoList}" var="info"
										varStatus="index">
										<tr class="cow">
											<td>
									...
									<c:if test="${fn:length(newCrdinfoList)==0}">
