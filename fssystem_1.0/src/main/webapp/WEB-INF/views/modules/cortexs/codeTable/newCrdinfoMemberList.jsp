	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$('#exportExcel').click(function() {
				...
				$("#form").attr("action","${pageContext.request.contextPath}/NewCrdinfoMember/exportExcel");
				$("#form").submit();
			});
			...
			$('#query').click(function() {
				...
				$("#form").attr("action","${pageContext.request.contextPath}/NewCrdinfoMember/list");
				$("#form").submit();
			});		
		});	
			...
			<div class="shm_contab">
				<div class="poup_right">
					<div class="shmcr_cont01">
						...
						<div class="shmc_tab2">
							<form id="form" action="${pageContext.request.contextPath}/NewCrdinfoMember/list"
								method="post">
