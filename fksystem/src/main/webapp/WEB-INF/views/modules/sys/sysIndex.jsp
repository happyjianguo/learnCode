		...
		<div id="header" class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				...
				<ul id="userControl" class="nav pull-right">
					<li><a href="${pageContext.request.contextPath}" title="首页"><i class="icon-home"></i></a></li>
...
<%-- 						<a class="dropdown-toggle" data-toggle="dropdown" href="#" title="个人信息">您好, ${fns:getUser().name}&nbsp;<span id="notifyNum" class="label label-info hide"></span></a>--%>
						<a class="dropdown-toggle" data-toggle="dropdown" href="#" title="个人信息">您好, ${fns:getUser().name}&nbsp;上次登录时间:${fns:getPastUser()[1]}&nbsp;,IP:${fns:getPastUser()[0]}<span id="notifyNum" class="label label-info hide"></span></a>
