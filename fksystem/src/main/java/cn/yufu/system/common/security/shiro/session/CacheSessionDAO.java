 ...
 */
package cn.yufu.system.common.security.shiro.session;
	...
	public Collection<Session> getActiveSessions(boolean includeLeave, Object principal, Session filterSession) {
		...
		for (Session session : getActiveSessions()){
			...
			if (principal != null){
				...
				//System.out.println(pc != null ? pc.getPrimaryPrincipal().toString() : StringUtils.EMPTY);
			...
			// 过滤掉的SESSION
			//System.out.println(filterSession != null ? filterSession.getId() : "空");
			//System.out.println(session.getId());
			if (filterSession != null){
				if (filterSession.getId().equals(session.getId())) {
					isActiveSession = false;
				}else if (flag == 1) {
					isActiveSession = true;
				}
