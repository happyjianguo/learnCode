			...
			<div class="mainbox">
				...
				<div class="tablebox">
					...
					<div class="follow_info">
						<span class="follow follow_term3">数据总数<span id="follow_term1"></span></span> 
						<span class="follow follow_term2">PV总数：<span id="follow_term2"></span></span> 
						<span class="follow follow_term1">UV总数：<span id="follow_term3"></span></span>
					</div>
	...
	<%@ include file="/WEB-INF/views/common/conmm.jsp"%>	
    	...
    	function getgameid(){
    		$.ax({
        		...
        		data : {appid:$('#appid').val(),channel:$('#channel').val()},
		        successfn : function(result) {	
