...
<script type="text/javascript" src="<c:url value='/resources/js/canvas-to-blob.js?v=${jsv}'/>"></script>
<script type="text/javascript" src="<c:url value='/resources/js/canvas-to-blob.min.js?v=${jsv}'/>"></script>
<script type="text/javascript" src="<c:url value='/resources/js/purify.js?v=${jsv}'/>"></script>
<script type="text/javascript" src="<c:url value='/resources/js/purify.min.js?v=${jsv}'/>"></script>
<script type="text/javascript" src="<c:url value='/resources/js/sortable.js?v=${jsv}'/>"></script>
<script type="text/javascript" src="<c:url value='/resources/js/sortable.min.js?v=${jsv}'/>"></script>
<script type="text/javascript" src="<c:url value='/resources/js/fileinput.js?v=${jsv}'/>"></script>
...
<script type="text/javascript" src="<c:url value='/resources/js/clipboard.min.js?v=${jsv}'/>"></script>  
<!-- 微信start -->
<%-- <script type="text/javascript" src="<c:url value='/resources/js/jquery-ui.min.js?v=${jsv}'/>"></script>
<script type="text/javascript" src="<c:url value='/resources/js/zh-cn.js?v=${jsv}'/>"></script>--%>
<script type="text/javascript" src="<c:url value='/resources/js/umeditor.min.js?v=${jsv}'/>"></script>
<script type="text/javascript" src="<c:url value='/resources/js/umeditor.config.js?v=${jsv}'/>"></script>
