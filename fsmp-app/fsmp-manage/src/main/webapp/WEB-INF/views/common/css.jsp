...
<link rel="stylesheet" type="text/css" media="all" href="<c:url value='/resources/css/base.css?v=${cssv}'/>" />
...
<link rel="stylesheet" type="text/css" media="all" href="<c:url value='/resources/css/templet.css?v=${cssv}'/>"/>
