...
public class CloudgameinitEntity {
	...
	/** 活动发布校验接口地址*/
    private String releseactivityurl;
    ...
    public String getReleseactivityurl() {
		return releseactivityurl;
	}

	public void setReleseactivityurl(String releseactivityurl) {
		this.releseactivityurl = releseactivityurl;
	}
	@Override
