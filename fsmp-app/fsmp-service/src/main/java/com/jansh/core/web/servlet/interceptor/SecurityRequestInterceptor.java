...
public class SecurityRequestInterceptor extends HandlerInterceptorAdapter {
	...
	/**
	 * 需要忽略的ignoreClassName
	 */
	public String[] ignoreControllerArray;
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
		...
		if (handler instanceof HandlerMethod) {
			...
			// 忽略需要忽略的ignoreClassName
			if (ignoreControllerArray != null) {
				for (String className : ignoreControllerArray) {
	...
	public void setIgnoreControllers(String ignoreControllers) {
		if (ignoreControllers != null) {
			this.ignoreControllerArray = ignoreControllers.split(",|;");
		}
	}
